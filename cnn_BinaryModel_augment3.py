...
def main():
	...
	inputs, labels = load_data('binary_augment_inputs3.npy', 'binary_augment_labels3.npy')

	
	inputs = (np.asarray(inputs)/255.0).astype(np.float32)
	...
	for batchsz in range(30, 100, 10):
